...
<template>
  ...
  <!--<div id="controlleroptions" class="parameterlist">
    <ul>
      ...
      <li
        class="item"
        v-tooltip="$t('tooltips.PreBolusTime')"
      ...
      <li class="item" v-tooltip="$t('tooltips.max_iob')">
        <label for="max_iob">
          ...
          <div class="item-input">
            <input
              type="number"
              v-model.number="profile.max_iob"
              id="max_iob"
              min="1"
              step="0.1"
              @change="valueChanged"
      ...
      <li class="item" v-tooltip="$t('tooltips.max_basal')">
        <label for="max_basal">
          ...
          <div class="item-input">
            <input
              type="number"
              v-model.number="profile.max_basal"
              id="max_basal"
              min="1"
              step="0.1"
              @change="valueChanged"
