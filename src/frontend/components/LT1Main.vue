            ...
            <div class="col-5" id="scenario-box">
              <div class="card">
                <div class="card-body">
                  ...
                  <h5 class="card-title">
                    Einführung in den LoopInsight AID-Simulator
                  </h5>
                  <div class="card-text">
                    <p>
                      In diesem Simulator können Sie in den verschiedenen
                      Reitern, Szenarien, Patient:in, Mahlzeiten oder AID-System
                      und Insulin, Paramter für die Simulation von z.B.
                      verschiedenen Szenarien durch den Algorithmus berechnen
                      und anzeigen lassen. Dabei können Sie in jedem Reiter
                      einzeln die Paramter anpassen oder zusätzlich ein
                      Szenario, wie z.B. Über- oder Unterzuckerung, dazu
                      auswählen.
                    </p>
                  </div>
                  <button
